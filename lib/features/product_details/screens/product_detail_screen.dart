...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    ...
    Navigator.pushNamed(context, ProductDetailsScreen.routeName, arguments: query);
  }
          ...
          children: [
            ...
            Container(
              ...
              Container(
                ...
                height: 300,
                child: Image.network(widget.product.images[0],fit: BoxFit.fitHeight,),
              ),
              Container(
              ...
              Row(
                children:  [
                  const Padding(
                    ...
                    child: Text("Deal Price : ",style: TextStyle(
                      fontSize: 18,
              ...
              RatingBar.builder(
                ...
                const Icon(Icons.star,color: GlobalVariable.secondaryColor,)
